<template>
  <div class="card">
    ...
    <div class="card-header">
      ...
      <p style="margin-top: 5px;  font-weight: 700;">KAY</p>
      <el-divider></el-divider>
    </div>
    <!--卡片中部--github地址-->
    <div class="card-middle">
      <div style="max-width: 40px;margin-left: 40px;padding-bottom: 20px;">
        <el-image :fit="fit"
...
export default {
  ...
  data() {
    return {
      ...
      fit: 'fill',
      user: {
        avatar: "https://cdn.jsdelivr.net/gh/yukikay/cdnPic@main/StaticPic/ava2.png"
      },
    }
  },
  methods: {
    //跳转到个人github
    goToGithub() {
      window.location.href = "https://github.com/yukikay"
    }
  },
  created() {
  }
